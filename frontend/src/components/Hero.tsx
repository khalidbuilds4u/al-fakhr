...
const slides = [
  {
    ...
    bgPositionMobile: "70% 80%" // Bottle is in right-center, lower portion of the frame
  },
  {
    id: 1,
    ...
    bgPositionMobile: "20% 70%" // Bottle is on the left side, lower portion of the frame
  }
];
